...
\centering
    \begin{minipage}{0.48\textwidth}
        \includegraphics[width=\linewidth]{"images/experiment kaggle/expected_memberships"}
    \end{minipage}
    \begin{minipage}{0.48\textwidth}
        \includegraphics[width=\linewidth]{"images/experiment kaggle/prediction_memberships"}
    \end{minipage}
...
\centering
    \begin{minipage}{0.48\textwidth}
        \includegraphics[width=\linewidth]{"images/experiment kaggle/expected_classification"}
    \end{minipage}
    \begin{minipage}{0.48\textwidth}
        \includegraphics[width=\linewidth]{"images/experiment kaggle/prediction_regression_rf"}
    \end{minipage}
...
\centering
    ...
    \end{minipage}
    \begin{minipage}{0.48\textwidth}
        \includegraphics[width=\linewidth]{"images/experiment kaggle/prediction_classification"}
    \end{minipage}
...
\centering
    \begin{minipage}{0.48\textwidth}
     \includegraphics[width=\linewidth]{"images/experiment kaggle/tn"}\label{tn_k}
   \end{minipage}
   \begin{minipage}{0.48\textwidth}
     \includegraphics[width=\linewidth]{"images/experiment kaggle/tp"}\label{tp_k}
   \end{minipage}
   \begin{minipage}{0.48\textwidth}
     \includegraphics[width=\linewidth]{"images/experiment kaggle/fn"}\label{fn_k}
   \end{minipage}
   \begin{minipage}{0.48\textwidth}
     \includegraphics[width=\linewidth]{"images/experiment kaggle/fp"}\label{fp_k}
   \end{minipage}
...
\centering
    ...
    \end{minipage}
    \begin{minipage}{0.48\textwidth}
        \includegraphics[width=\linewidth]{"images/experiment kaggle/prediction_classification_rf"}
    \end{minipage}
...
\centering
    ...
    \end{minipage}
    \begin{minipage}{0.48\textwidth}
        \includegraphics[width=\linewidth]{"images/experiment kaggle/prediction_classification_dectree"}
    \end{minipage}
...
\centering
    ...
    \end{minipage}
    \begin{minipage}{0.48\textwidth}
        \includegraphics[width=\linewidth]{"images/experiment kaggle/prediction_classification_nn"}
    \end{minipage}
...
\centering
    ...
    \end{minipage}
    \begin{minipage}{0.48\textwidth}
        \includegraphics[width=\linewidth]{"images/experiment kaggle/prediction_classification_svc"}
    \end{minipage}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.48]{"images/experiment kaggle/overlaypred"}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.48]{"images/experiment kaggle/indecisionrf"}
