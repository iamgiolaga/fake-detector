...
\STATE in\_evaluation = in\_model.evaluate(in\_predictions, in\_test.y)
...
\STATE optimized\_model = optimized\_model.fit(train, train.x)
...
\begin{itemize}
    ...
    \item se si generano misture di parole appartenenti a topic differenti tramite un processo stocastico, come la Latent Dirichlet Allocation, l'algoritmo Random Forest ottiene notevoli risultati, riproducendo in modo relativamente accurato le etichette attese;
